...
| **Protección de Ramas** | `sync-rulesets.yml` | Aplica Rulesets (Protect main) con squash merge y restricciones de borrado. |
...
Para que tu repo tenga las etiquetas de colores y la rama `main` protegida automáticamente:
...
* Ejecútalo manualmente desde la pestaña **Actions**.
...
* [**rulesets.json**](./rulesets.json): Reglas de protección para `main` (Squash, 1 review requerida).
